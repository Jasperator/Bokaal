            ...
            ?>
                <ul class="alles" >
                    ...
                    <li class="listItem" <?php if ($page == "search.php") : echo "active"; ?> class="active"<?php
                        ...
                        <a class="nav-link" href="../items/search.php"> <img class="nav-img" src="../../images/icon/zoek.png" alt="zoek icon"> <p class="nav-bar_name">Items</p> </a>
                    </li>
                    ...
                    <?php 
                     ...
                     <li class="listItem" <?php if ($page == "sell.php") : echo "active";?> class="active"<?php
                        ...
                        <a class="nav-link"  href="../../sell.php"> <img class="nav-img" src="../../images/icon/add.png" alt="zoek icon"><p class="nav-bar_name">Verkoop</p></a>
                    </li>
                     <?php
                        endif;?>
                    ...
                    <li class="listItem" <?php if ($page == "cart.php") : echo "active";?> class="active"<?php
                        ...
                        <a class="nav-link"  href="../items/cart.php"> <img class="nav-img" src="../../images/icon/cart.png" alt="zoek icon"> <p class="nav-bar_name">Winkelkar</p></a>
                    </li>
                    <li class="listItem" <?php if ($page == "profile.php") : echo "active";?> class="active"<?php
                                        endif; ?>>
                        <a class="nav-link"  href="../profile/favor.php"><i class="fas fa-user"></i> <img class="nav-img" src="../../images/icon/user.png" alt="zoek icon"> <p class="nav-bar_name">Profiel</p> </a>
                    </li>
